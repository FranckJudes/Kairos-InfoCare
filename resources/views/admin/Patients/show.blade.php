@extends('admin.main-layout')
                                ...
                                <div class="card-body">
                                  <div class="table-responsive">
                                    <div id="table-1_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="table-1_length">
                                      ...
                                      <thead>
                                        <tr role="row">
                                            <th class="text-center sorting_asc" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1" aria-label="#: activate to sort column descending" style="width: 22.9219px;" aria-sort="ascending">#</th>
                                            <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="table-2" style="width: 81.9844px;">name</th>
                                            <th class="text-center sorting_asc" tabindex="0" aria-controls="table-3" rowspan="1" colspan="1" aria-label="#: activate to sort column descending" style="width: 22.9219px;" aria-sort="ascending">Taille </th>
  ...
  <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <script>
      var zTreeObj; 
      var id_Noeud;
      var franck = document.getElementById('id_planClassement');
      console.log(franck);      
